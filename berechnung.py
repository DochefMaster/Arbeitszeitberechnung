...
def berechnung_arbeitsstunden_tag(anzahl_arbeitstage_pro_woche, arbeits_pensum, arbeitstage_ferien, arbeitsferien_woche, vorhandene_ueberzeit=0, brueckentage_frei=0, jahresarbeit_tage=0, jahresarbeit_stunden=0):
